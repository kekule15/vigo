              ...
              : authservice.allUserAdmins.data!.isEmpty == true
                  ...
                  : Column(
                      children: List.generate(
                          authservice.allUserAdmins.data!.length, (index) {
                        return Padding(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: ListTile(
                                onTap: () {
                                  var peerid = auth.currentUser!.uid.hashCode <
                                          authservice.allUserAdmins.data![index]
                                              .id.hashCode
                                      ? '${auth.currentUser!.uid}_${authservice.allUserAdmins.data![index].id}'
                                      : '${authservice.allUserAdmins.data![index].id}_${auth.currentUser!.uid}';

                                  Get.to(() => Chat(
                                      peerid: peerid,
                                      name: authservice
                                          .allUserAdmins.data![index]['name'],
